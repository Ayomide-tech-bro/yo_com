...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <img src="img/3.jpeg" width="100%" id="mainimg">
   
       <div class="small-img-group">
           <div class="small-img-col">
          <img src="img/1ele.jpeg" width="100%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/16.jpeg" width="120%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/ed1.jpeg" width="80%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/ED2.jpeg" width="80%" class="smallimg" alt="">
        </div>
