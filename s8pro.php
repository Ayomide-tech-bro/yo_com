...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <img src="img/Arm (1).jpeg" width="100%" id="mainimg">
   
       <div class="small-img-group">
           <div class="small-img-col">
          <img src="img/Arm (2).jpeg" width="100%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/Arm (3).jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/ham (1).jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/ham (2).jpeg" width="100%" class="smallimg" alt="">
        </div>
    ...
    <div class="single-pro-details">
      ...
      <br>
       ...
       <span>Find a great swlection of women clothing at Zella shop dresses, rop , jacket ,jeans sweater and more from a varietyof top Brands</span>
    </div>
</section>
