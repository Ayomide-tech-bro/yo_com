...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <img src="img/s2.jpeg" width="100%" id="mainimg">
   
       <div class="small-img-group">
           <div class="small-img-col">
          <img src="img/s23.jpeg" width="100%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/s20.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/s21.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/s22.jpeg" width="100%" class="smallimg" alt="">
        </div>
    ...
    <div class="single-pro-details">
      ...
      <!-- <a href="cart.php"> <button class="normal">Add to cart</button></a> -->
      <!-- <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="normal">Add to cart</button> -->
      <div class="border border-light p-1">
                <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="normal">Update Picture</button>
            </div>
