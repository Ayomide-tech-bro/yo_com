...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <img src="img/4.jpeg" width="100%" id="mainimg">
   
       <div class="small-img-group">
           <div class="small-img-col">
          <img src="img/s5.jpg" width="100%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/s6.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/s7.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/s15.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/4.jpeg" width="100%" class="smallimg" alt="">
        </div>
    ...
    <div class="single-pro-details">
        ...
        <h6>Co-operate /Polo</h6>
        <h4>Mens fashion Polo</h4>
        <h2>#8500</h2>
        <select>
