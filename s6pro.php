...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <img src="img/q1.jpeg" width="100%" id="mainimg">
   
       <div class="small-img-group">
           <div class="small-img-col">
          <img src="img/q2.jpeg" width="120%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/q3.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/q4.jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/q5.jpeg" width="100%" class="smallimg" alt="">
        </div>
