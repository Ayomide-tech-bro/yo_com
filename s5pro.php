...
<body>
    ...
    <section id="prodetails" class="section-p1 section-m1">
       ...
       <div class="small-img-group">
          ...
          <img src="img/images (1).jpeg" width="100%" class="smallimg" alt="">
       </div>
       <div class="small-img-col">
           <img src="img/images (2).jpeg" width="100%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/images.jpeg" width="80%" class="smallimg" alt="">
        </div>
        <div class="small-img-col">
           <img src="img/b.jpeg" width="100%" class="smallimg" alt="">
        </div>
    ...
    <div class="single-pro-details">
      ...
      <br>
       ...
       <span>Exploir a collectiom of fantastic women's  shape wear online at zella . With everything from pajamas to night gown at nighties...</span>
    </div>
</section>
